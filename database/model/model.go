// Package model defines the database models and data structures used by the x-ui-pro panel.
package model
...
// User represents a user account in the x-ui-pro panel.
type User struct {
...
// Setting stores key-value configuration settings for the x-ui-pro panel.
type Setting struct {
	Id    int    `json:"id" form:"id" gorm:"primaryKey;autoIncrement"`
